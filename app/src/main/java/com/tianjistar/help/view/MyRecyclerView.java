package com.tianjistar.help.view;
...
//    public void setEmptyView(OnClickListener clickListener) {
...
//            if (dra == 0) {
//                iv_reason.setImageResource(R.drawable.list_loading);
